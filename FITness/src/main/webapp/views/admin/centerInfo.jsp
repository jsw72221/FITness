...
<body>
	 ...
	 <section id="content">
        <h2 align="center">${gym.gymName } 상세 정보</h2><br><br>
        <div id="join_wrap">	 	
            <form name="joinform" action="${ path }/member/join" method="POST">
                <table height="600px">
                    <tr>
                        <th width="25%">센터 명</th>
                        <td>
                            <input type="text" name="Id" id="Id" placeholder="센터 명을 입력해주세요" required size="40"
                            value= "${gym.gymName }">
                    ...
                    <tr>
                        <th>카테고리</th>
                        <td>
                            <input type="text" id="cate" name="cate" size="40"
                            value= "${gym.category }">
                        </td> 			
                    </tr>
                    <tr>
                        <th>대표 연락처</th>
                        <td>
                            <input type="tel" id="" placeholder= "연락처를 입력해주세요" size="40"
                            value= "${gym.ceoPhone }">
                        </td> 			
                    </tr>
                    <tr>
                        <th>대표 이메일</th>
                        <td>
                            <input type="email" name="userName" id="userName" placeholder="이메일을 입력해주세요"  required  size="40"
                            value= "${gym.ceoEmail }">				
                        </td> 			
                    </tr>
                    <tr>
                        <th>운영시간</th>
                        <td>
                            <input type="text" placeholder="www.FITness.com" name="phone" id="phone" maxlength="11"  size="40"
                            value= "${gym.time }">								
                        </td> 			
                    </tr>
                    <tr>
                ...
                <button id="btn_join" onclick="location.href='${ path }/admin/centerlist'">목록으로</button>
            </form>
            <div>   
