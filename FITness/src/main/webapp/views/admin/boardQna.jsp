...
<body>
    <div class="wrap">
        ...
        <div id="content3">
        <!-- 맨 처음으로 -->
			<button onclick="location.href='${ path }/admin/boardqna?page=1'">&lt;&lt;</button>

			<!-- 이전 페이지로 -->
			<button onclick="location.href='${ path }/admin/boardqna?page=${ pageInfo.prevPage }'">&lt;</button>
			...
			<c:forEach begin="${ pageInfo.startPage }" end="${ pageInfo.endPage }" varStatus="status">
				<c:choose>
					...
					<c:otherwise>
						<button onclick="location.href='${ path }/admin/boardqna?page=${ status.current }'">${ status.current }</button>
					</c:otherwise>
				</c:choose>
			</c:forEach>
			...
			<!-- 다음 페이지로 -->
			<button onclick="location.href='${ path }/admin/boardqna?page=${ pageInfo.nextPage }'">&gt;</button>

			<!-- 맨 끝으로 -->
			<button onclick="location.href='${ path }/admin/boardqna?page=${ pageInfo.maxPage }'">&gt;&gt;</button>
        </div>
