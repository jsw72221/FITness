...
public class PageInfo {
	 ...
	 * @param pageLimit 한 페이지에 보이는 페이지의 수 (ex. 5페이지) 
	 * @param listCount 전체 리스트의 수 (ex. 122개 쿼리문으로 test 할 수 있도록 등록해 둠)
	 * @param listLimit 한 페이지에 표시될 게시글 리스트의 수 (ex. 5개씩 보기, 10개씩 보기)
	 */
	...
	public int getPrevPage() {
		...
		// 1보다 작으면, 1을 리턴, 그렇지 않으면 이전 페이지 리턴
